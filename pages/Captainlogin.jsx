...
const Captainlogin = () => {
  ...
  return (
    <div className="p-7 h-screen flex flex-col justify-center">
      ...
      <div>
        <Link to='/login' className="bg-[#d5622d] flex items-center justify-center text-white font-semibold mt-3 mb-7 rounded px-4 py-2 w-full text-lg placeholder:text-base">
          Sign in as User
        </Link>
      </div>
    </div>
